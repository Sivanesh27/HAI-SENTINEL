"""
Execution script to run the full HAI-Sentinel ML Training & Calibration Pipeline
"""
import sys
import os
...
def main():
    print("==================================================")
    print("  HAI-SENTINEL MACHINE LEARNING PIPELINE TRAINING ")
    print("==================================================")
    ...
    # 2. Clean timeseries
    print("\n[STEP 2] Preprocessing & physiological bound checking...")
